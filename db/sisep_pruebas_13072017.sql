...
CREATE TABLE IF NOT EXISTS `apropiacion_actor` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `apropiacion_social` (
  `pkID` int(11) NOT NULL,
  `fkID_nombre` int(11) NOT NULL,
  ...
  `otros_participantes` int(11) NOT NULL,
  `fkID_tipo` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banco_respuestas_p` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cambio_estado_grupo_inv` (
  `pkID` int(11) NOT NULL,
  `fecha` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cursosF_proyectoM` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `curso_formacion` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_actor` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_apropiacionS` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_asesoria` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_grupoF` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_infraestructura` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documentos_proyectoM` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
  `fkID_proyectoM` int(11) NOT NULL
...
CREATE TABLE IF NOT EXISTS `documentos_prueba` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `url` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estado_grupo_inv` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `estado_pregunta_bitacora` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `grupos_proyectoM` (
  `pkID` int(11) NOT NULL,
  `fkID_grupo` int(11) NOT NULL,
  `fkID_proyectoM` int(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `grupo_formacion` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `institucion_infraestructura` (
  `pkID` int(11) NOT NULL,
  `fkID_institucion` int(11) NOT NULL,
  `fkID_infraestructura` int(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `institucion_proyectoM` (
  `pkID` int(11) NOT NULL,
  `fkID_institucion` int(11) NOT NULL,
  `fkID_proyectoM` int(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `lugar_apropiacion` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
...
(6, 'Ciencias sociales'),
(7, 'Geografía'),
(8, 'Ciencias económicas y políticas'),
(9, 'Historia Geografía'),
(10, 'Democracia'),
(11, 'Educación Ética y en Valores'),
...
(26, 'Estadística'),
(27, 'Trigonometría'),
(28, 'Tecnología e informática'),
(29, 'Director de Curso');
...
CREATE TABLE IF NOT EXISTS `meta_valor` (
  `pkID` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `nombre_apropiacionS`
--

CREATE TABLE IF NOT EXISTS `nombre_apropiacionS` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
);

--
-- Volcado de datos para la tabla `nombre_apropiacionS`
--
...
CREATE TABLE IF NOT EXISTS `preguntas_b` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pregunta_p` (
  `pkID` int(11) NOT NULL,
  `pregunta` text NOT NULL,
  `fkID_prueba` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `proyectoM_municipio` (
  `pkID` int(11) NOT NULL,
  `fkID_proyectoM` int(11) NOT NULL,
  `fkID_municipio` int(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `proyecto_marco` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `fecha_ini` date NOT NULL,
  `fecha_fin` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `respuestas_b` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `respuesta_p` (
  `pkID` int(11) NOT NULL,
  `respuesta` text,
  `fkID_pregunta_p` int(11) NOT NULL,
  `fkID_usuario` int(11) NOT NULL
...
CREATE TABLE IF NOT EXISTS `respuesta_p_banco` (
  `pkID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tipo_apropiacion_social` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
) ;
...
(3, 'Grupos Ondas y Comunidad en General');
...
CREATE TABLE IF NOT EXISTS `tipo_documento_id` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `tipo_pregunta_p` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL
) ;
...
(1, 'root', '8cb2237d0679ca88db6464eac60da96345513964', '', 'root', 'root', '', 1, 0, '', '0000-00-00', NULL, NULL, NULL, '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `usuario_grupo_formacion` (
  `pkID` int(11) NOT NULL,
  `fkID_usuario` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usuario_proyectoM` (
  `pkID` int(11) NOT NULL,
  `fkID_usuario` int(11) NOT NULL,
  `fkID_proyectoM` int(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `valores_meta` (
  `pkID` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
...
--
-- Indices de la tabla `nombre_apropiacionS`
--
ALTER TABLE `nombre_apropiacionS`
  ADD PRIMARY KEY (`pkID`);
...
--
ALTER TABLE `asesoria`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT de la tabla `auditoria`
--
ALTER TABLE `auditoria`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=506;
--
-- AUTO_INCREMENT de la tabla `banco_respuestas_p`
--
ALTER TABLE `banco_respuestas_p`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=206;
--
...
--
ALTER TABLE `grupo_etnico`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=101;
--
...
--
ALTER TABLE `municipio`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1101;
--
...
ALTER TABLE `nivel_formacion`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `nombre_apropiacionS`
--
ALTER TABLE `nombre_apropiacionS`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `permisos`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=322;
--
-- AUTO_INCREMENT de la tabla `preguntas_b`
--
ALTER TABLE `preguntas_b`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=135;
--
...
--
ALTER TABLE `respuestas_b`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=111;
--
-- AUTO_INCREMENT de la tabla `respuesta_p`
--
ALTER TABLE `respuesta_p`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT de la tabla `respuesta_p_banco`
--
ALTER TABLE `respuesta_p_banco`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `usuarios`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=96;
--
...
--
ALTER TABLE `usuario_proyectoM`
  MODIFY `pkID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
