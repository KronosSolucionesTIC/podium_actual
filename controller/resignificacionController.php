...
include_once '../DAO/resignificacionDAO.php';
include_once 'helper_controller/render_table.php';

class resignificacionController extends resignificacionDAO
{
    ...
    public function getTablaResignificacion($filtro, $pkID_proyectoM)
    {
        ...
        $array_opciones = [
            "modulo" => "resignificacion", //nombre del modulo definido para jquerycontrollerV2
            "title"  => "Click Ver Detalles", //etiqueta html title
            "href"   => "detalles_resignificacion.php?id_resignificacion=",
            "class"  => "detail", //clase que permite que añadir el evento jquery click
        ];
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        if ($filtro == "'Todos'") {
            $grupo = $this->getResignificaciones($pkID_proyectoM);
        } else {
            $grupo = $this->getResignificacion($filtro, $pkID_proyectoM);
        }
