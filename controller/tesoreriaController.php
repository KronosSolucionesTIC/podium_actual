...
include_once '../DAO/tesoreriaDAO.php';
include_once 'helper_controller/render_table.php';

class tesoreriaController extends tesoreriaDAO
{
    ...
    public function getTablaProyectoMarco()
    {
        ...
        $array_opciones = [
            ...
            "href"   => "tesoreria.php?id_proyecto=",
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="portlet box blue-hoki ">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="col-md-6">
                                          <div class="caption">
                                              <h4><i class="fa fa-folder-open"><span class="titletesoreria"  title="' . $value["nombre"] . '" style="cursor: default;"> ' . getNombreProyM($value["nombre"], 12) . '</span></i></h4>
                                          </div>
                                        </div>
