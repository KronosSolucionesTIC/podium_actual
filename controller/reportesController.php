...
class reportesController extends reportesDAO
{
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="portlet box blue-hoki ">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="col-md-6">
                                          <div class="caption">
                                              <h4><i class="fa fa-folder-open"><span class="titlereportes"  title="' . $value["nombre"] . '" style="cursor: default;"> ' . getNombreProyM($value["nombre"], 12) . '</span></i></h4>
                                          </div>
                                        </div>
