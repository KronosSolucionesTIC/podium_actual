...
$descripcion_foto = isset($_POST['descripcion_foto_tiex'])? $_POST['descripcion_foto_tiex'] : "";
            ...
            foreach($_FILES['url_foto']['name'] as $key=>$val){
                ...
                if(in_array($fileType, $allowTypes)){    
                    ...
                    if(move_uploaded_file($_FILES['url_foto']['tmp_name'][$key],$targetFilePath)){
                        ...
                        $q_inserta  = "insert into `fotos_tiex`(`url_foto`, `descripcion`, `fkID_album`) VALUES ('$nombre', '$descripcion_foto', '$fkID_album')";
                            $r["query"] = $q_inserta;
