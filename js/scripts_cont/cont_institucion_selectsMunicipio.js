$(function(){
	...
	function carga_Municipio(pkID_departamento){
	    ...
	    .done(function(data) {
	        ...
	        if (data.mensaje != "No hay registros.") {
	        	...
	        	$("#fkID_municipio").append('<option></option>')
	        	...
	        	$.each(data.mensaje, function(index, val) {
		        	 ...
		        	 $("#fkID_municipio").append('<option value="'+val.pkID+'">'+val.nombre+'</option>')	        	 
		        });
