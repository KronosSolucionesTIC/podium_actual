...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <h1 class="page-header titleprincipal"><img src="../img/botones/proyectosonly.png">Proyectos</h1> 
      </div>        
      <!-- /.col-lg-12 -->
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            <li><a class="migadepan" <?php echo 'href="index.php?id_proyectoM='.$proyectoInst->getcpm().'"'; ?>>Inicio</a></li>
            <li class="active migadepan">Proyectos</li>
          </ol>
      </div>
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <!--<button id="btn_nuevoproyecto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_proyecto" <?php if ($crea != 1){echo 'disabled="disabled"';} ?> >
                 <span class="glyphicon glyphicon-plus"></span>Nuevo proyecto</button>-->  
              </div>
            </div>
