...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
    <!-- Campo que contiene el valor del id del modulo para auditoria con el nombre del modulo-->
      <input type="hidden" id="id_mod_page_indicador" value=<?php echo $id_modulo ?>>
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li class="active migadepan">Indicadores</li>
          </ol>
      </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="titleprincipal"><h4>Registro de Indicadores</h4></div>
              </div>
              <div class="col-md-6 text-right">
                 <button id="btn_nuevoindicador" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_indicador" <?php if ($crea != 1){echo 'disabled="disabled"';} ?> >
        ...
        <div class="panel-body">
          <div class="dataTable_wrapper">
              <table class="display table table-striped table-bordered table-hover" id="tbl_indicador">
                  <thead>
                      <tr>                         
                          <th>Nombre</th>
                          <th>Descripción</th>                          
                  ...
                  <tbody>
                      <?php                          
                          $indicadorInst->getTablaIndicador();                        
                       ?>
                  </tbody>
              </table>
          </div>
