...
$proyectoMGen = $saberesInst->getProyectosMarcoGrupo($pkID_grupo);
...
include "form_fotos_saberes.php";
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="principal.php?id_proyectoM=<?php echo $proyectoMGen[0]["fkID_proyectos"]; ?>" class="migadepan">Menú principal</a></li>
            <li><a href="academico.php?id_proyectoM=<?php echo $proyectoMGen[0]["fkID_proyectos"]; ?>" class="migadepan">Académico</a></li>
            <li><a href="saberes_propios.php?id_proyectoM=<?php echo $proyectoMGen[0]["fkID_proyectos"]; ?>" class="migadepan">Saberes Propios</a></li>
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs tabs-proc3" role="tablist">
	        ...
	        <li id="li_album" role="presentation"><a href="#album" aria-controls="general" role="tab" data-toggle="tab">Fotos</a></li>
	    </ul>
...
?>
				...
				<div class="panel panel-default proc-pan-def3">
					...
					<div class="titulohead">
			            ...
			            <div class="row">
			              ...
			              <div class="col-md-6 text-right">
			      			 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal"  data-saber="<?php echo $pkID_grupo ?>" data-target="#frm_modal_foto_saber" <?php if (($creaeg != 1) || ($ne >= 30)) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> 
			      			 Nueva Foto</button>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $saberesInst->getFotosSaberes($pkID_grupo);
        if ($fotos[0]["pkID"]!="") { 
