...
$albumGrupo = $biotecnologiaInst->getBiotecnologiaGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_biotecnologia.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="biotecnologia.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Biotecnologia</a></li>
            <li><a href="detalles_biotecnologia.php?id_biotecnologia=<?php echo $albumGrupo[0]["fkID_biotecnologia"]; ?>" class="migadepan">Detalle Biotecnologia</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_biotecnologia" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $biotecnologiaInst->getFotosBiotecnologia($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
