...
$acompaniamientoInst = new acompanamientoController();

$arrPermisoss = $acompaniamientoInst->getPermisosModulo_Tipo(26, $_COOKIE[$NomCookiesApp . '_IDtipo']);
...
$albumGrupo = $acompaniamientoInst->getAcompaniamientoGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_acompanamiento.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="academico.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Académico</a></li>
            <li><a href="formacion.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Formación a Maestros</a></li>
            <li><a href="acompanamiento.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Acompañamiento a Maestros</a></li>
            <li><a href="detalles_acompanamiento.php?id_acompanamiento=<?php echo $albumGrupo[0]["fkID_acompanamiento"]; ?>" class="migadepan">Detalle Acompañamiento a Maestros</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_acompanamiento" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $acompaniamientoInst->getFotosAcompanamiento($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
