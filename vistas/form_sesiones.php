<!-- Form actor-->
<div class="modal fade bs-example-modal-lg" id="frm_modal_sesion" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header fondomodalheader">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <div class="imgedicion"></div><h3 class="modal-title titulomodal" id="lbl_form_sesion">-</h3>
      </div>
      <div class="modal-body">
        <!-- form modal contenido -->
                ...
                <br>
                    ...
                    <div class="form-group">
                        <label for="descripcion" class="control-label">Descripción de la Sesión</label>                        
