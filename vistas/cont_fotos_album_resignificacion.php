...
$arrPermisoss = $resignificacionInst->getPermisosModulo_Tipo(26, $_COOKIE[$NomCookiesApp . '_IDtipo']);
...
$albumGrupo = $resignificacionInst->getResignificacionGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_resignificacion.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="resignificacion.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Resignificación maestros</a></li>
            <li><a href="detalles_resignificacion.php?id_resignificacion=<?php echo $albumGrupo[0]["fkID_resignificacion"]; ?>" class="migadepan">Detalle Resignificación a Maestros</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_resignificacion" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $resignificacionInst->getFotosResignificacion($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
