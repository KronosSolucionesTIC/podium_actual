<!-- Form estudiantes -->
<div class="modal fade bs-example-modal-lg" id="frm_modal_album_aula" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header fondomodalheader">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <div class="imgedicion"></div><h3 class="modal-title titulomodal" id="lbl_form_album_aula">-</h3>
      </div>
      <div class="modal-body">
        <!-- form modal contenido -->

                <form id="form_album_aula" method="POST">  
                <br>
                  ...
                  <div class="form-group " hidden>
                    ...
                    <div class="form-group " hidden>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fkID_aula" name="fkID_aula" value="<?php echo $pkID_aulas; ?>">
                        </div>
                    </div>
      ...
      <div class="modal-footer">
        <button id="btn_actionalbum_aula" type="button" class="btn btn-primary botonnewgrupo" data-action="-">
            <span id="lbl_btn_actionalbum_aula"></span>
        </button>
      </div>
    </div>
  </div>
