<!-- Form estudiantes -->
<div class="modal fade bs-example-modal-lg" id="frm_modal_album_feria" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header fondomodalheader">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <div class="imgedicion"></div><h3 class="modal-title titulomodal" id="lbl_form_album_feria">-</h3>
      </div>
      <div class="modal-body">
        <!-- form modal contenido -->

                <form id="form_album_feria" method="POST">
                <br>
                  ...
                  <div class="form-group " hidden>
                    ...
                    <div class="form-group " hidden>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fkID_feria" name="fkID_feria" value="<?php echo $pkID_feria; ?>">
                        </div>
                    </div>
      ...
      <div class="modal-footer">
        <button id="btn_actionalbum_feria" type="button" class="btn btn-primary botonnewgrupo" data-action="-">
            <span id="lbl_btn_actionalbum_feria"></span>
        </button>
      </div>
    </div>
  </div>
