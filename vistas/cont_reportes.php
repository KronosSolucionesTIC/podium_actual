...
//--------------------------------------------------------------------
include '../controller/reportesController.php';
//--------------------------------------------------------------------
//intancias menu reportes
$reportesInst   = new reportesController();
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="titulohead">
                            <div class="text-center titulo-menu"><h3>Menú reportes</h3></div>
                        </div>
                        <div class="panel-body">

                            <div class="col-lg-12">
                                  <ol class="breadcrumb migadepan">
                                    <li class="active migadepan">Menú reportes</li>
                                  </ol>
                              </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="grupoInv">
                                        ...
                                        <div class="">
                                            <div class="">
                                                <div class="col-md-6 zoom text-center"><a class="" href="ingresos_gastos.php"><img class="zoom" src="../img/talento_humano.png"></a></div>
