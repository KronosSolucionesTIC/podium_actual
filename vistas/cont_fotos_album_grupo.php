...
$arrPermisoss = $grupoInst->getPermisosModulo_Tipo(26, $_COOKIE[$NomCookiesApp . '_IDtipo']);
...
$albumGrupo = $grupoInst->getGrupoGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_grupo.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="grupo.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Grupos Ondas</a></li> 
            <li><a href="detalles_grupo.php?id_grupo=<?php echo $albumGrupo[0]["fkID_grupo"]; ?>" class="migadepan">Detalle Grupo Onda</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_grupo" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $grupoInst->getFotosGrupo($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
