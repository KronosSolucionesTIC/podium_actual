<!-- Form estudiantes -->
<div class="modal fade bs-example-modal-lg" id="frm_modal_foto_taller" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header fondomodalheader">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <div class="imgedicion"></div><h3 class="modal-title titulomodal" id="lbl_form_foto_taller">-</h3>
      </div>
      <div class="modal-body">
        <!-- form modal contenido -->

                <form id="form_foto_taller" method="POST" enctype="multipart/form-data">
                <br>
      ...
      <div class="modal-footer">
        <button id="btn_actionfoto_taller" type="button" class="btn btn-primary botonnewgrupo" data-action="-">
            <span id="lbl_btn_actionfoto_taller"></span>
        </button>
      </div>
    </div>
  </div>
