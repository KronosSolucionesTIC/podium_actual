...
$albumGrupo = $aulaInst->getTiexGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_tiex.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="tiex.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">TIEX</a></li>
            <li><a href="detalles_tiex.php?id_tiex=<?php echo $albumGrupo[0]["fkID_tiex"]; ?>" class="migadepan">Detalle TIEX</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_tiex" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $aulaInst->getFotosTiex($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
