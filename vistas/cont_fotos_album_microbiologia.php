...
$biotecnologiaInst = new microbiologiaController();

$arrPermisoss = $biotecnologiaInst->getPermisosModulo_Tipo(26, $_COOKIE[$NomCookiesApp . '_IDtipo']);
...
$albumGrupo = $biotecnologiaInst->getMicrobiologiaGaleria($pkID_album); 
$proyectoMGen   = $docentesInst->getProyectosMarcoId($pkID_proyectoM);

include 'form_fotos_microbiologia.php';
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a href="microbiologia.php?id_proyectoM=<?php echo $albumGrupo[0]["fkID_proyecto"]; ?>" class="migadepan">Talleres de Microbiologia</a></li>
            <li><a href="detalles_microbiologia.php?id_microbiologia=<?php echo $albumGrupo[0]["fkID_microbiologia"]; ?>" class="migadepan">Detalle Talleres de Microbiologia</a></li>
  ...
  <div class="row">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                 <button id="btn_nuevafoto" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_foto_microbiologia" <?php if ($creaD != 1) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Nueva Foto</button>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <?php
        $nums=1;
        $fotos = $biotecnologiaInst->getFotosMicrobiologia($pkID_album);
        if ($fotos[0]["pkID"]!="") { 
